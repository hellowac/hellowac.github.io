...
- **前缀**: ``
- **命名空间**: **`http://purl.oclc.org/ooxml/spreadsheetml/main`**
- **相关命名空间**:
    - `xdr`: [**`http://purl.oclc.org/ooxml/drawingml/spreadsheetDrawing`**](./dml-spreadsheetDrawing.md)
...
<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema"
  ...
  <xsd:import namespace="http://purl.oclc.org/ooxml/drawingml/spreadsheetDrawing"

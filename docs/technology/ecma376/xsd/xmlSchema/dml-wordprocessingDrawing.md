...
- **相关命名空间**:
    ...
    - `w`: [**`http://purl.oclc.org/ooxml/wordprocessingml/main`**](./wml.md)
    - `dpct`: [**`http://purl.oclc.org/ooxml/drawingml/picture`**](./dml-picture.md)
    - `r`: [**`http://purl.oclc.org/ooxml/officeDocument/relationships`**](./shared-relationshipReference.xsd.md)

...
- **前缀**: ``
- **命名空间**: **`http://purl.oclc.org/ooxml/officeDocument/extendedProperties`**
- **相关命名空间**:
    - `vt`: [**`http://purl.oclc.org/ooxml/officeDocument/docPropsVTypes`**](./shared-documentPropertiesVariantTypes.md)
...
<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema"
  ...
  <xsd:import namespace="http://purl.oclc.org/ooxml/officeDocument/docPropsVTypes"
